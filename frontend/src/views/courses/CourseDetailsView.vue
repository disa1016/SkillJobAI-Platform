...
const loadProgress = async () => {
    ...
    completedLessonIds.value = data.map((item) => item.lessonId);
};
...
<template>
    <div class="container mt-4">
        ...
        <template v-else-if="course">
            ...
            <button type="button" class="btn btn-primary mb-4" :disabled="enrolling" @click="enroll">
            ...
            <div v-for="lesson in lessons" v-else :key="lesson.id" class="card shadow-sm mb-3">
                <div class="card-body">
                    <h5>
                        {{ lesson.orderNumber }}.
                    ...
                    <a v-if="lesson.videoUrl" :href="lesson.videoUrl" target="_blank" rel="noopener noreferrer"
