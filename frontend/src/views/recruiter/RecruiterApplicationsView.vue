...
<template>
    <div class="container py-4">
        ...
        <div v-if="applicationsLoading" class="alert alert-info">
            Bewerbungen werden geladen...
        </div>

        <template v-else>
            <div v-if="hasApplications" class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div v-for="(application, index) in applications" :key="application.id"
                        ...
                        <div v-if="!hasSkills(application)" class="alert alert-warning">
            ...
            <p v-if="hasSelectedJob && !hasApplications" class="text-muted">
