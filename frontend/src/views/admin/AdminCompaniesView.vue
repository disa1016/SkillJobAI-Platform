    ...
    <div class="container py-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <button type="button" class="btn btn-success btn-sm" :disabled="loading" @click="createCompany">
                    Neue Firma
                </button>

                <button type="button" class="btn btn-outline-primary btn-sm" :disabled="loading" @click="loadCompanies">
                    Aktualisieren
                </button>
            </div>
        </div>
                                ...
                                <tr v-for="company in companies" :key="company.id">
                                    ...
                                    <td>
                                        <img v-if="company.logoUrl" :src="getLogoSrc(company.logoUrl)"
                                            :alt="company.name" style="width: 48px; height: 48px; object-fit: contain"
                                    ...
                                    <td style="min-width: 260px">
                                        ...
                                        <button type="button" class="btn btn-outline-success btn-sm"
                                            :disabled="!selectedFiles[company.id]" @click="uploadLogo(company)">
                                            Logo hochladen
                                        </button>
                                    </td>
