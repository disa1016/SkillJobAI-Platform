...
<template>
  <div class="container py-4">
    ...
    <BaseSpinner
      v-if="loading"
      message="Bewerbungen werden geladen..."
    />
    ...
    <template v-else>
      <BaseEmptyState
        ...
        message="Du hast noch keine Bewerbungen gesendet."
      />
      ...
      <div v-else class="row g-3">
        ...
        >
          <BaseCard cardClass="h-100">
            ...
            <BaseAlert
              v-if="application.status === APPLICATION_STATUS.REJECTED"
              type="warning"
              class="mt-3"
            ...
            <BaseAlert
              v-if="application.status === APPLICATION_STATUS.ACCEPTED"
              type="success"
              class="mt-3"
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
              ...
              <router-link
                v-if="application.job?.id"
                :to="`/jobs/${application.job.id}/skill-gap`"
